<?php
namespace Lahman2016\Model\Table;
 ...
 * Master Model
 *
 * @method \Lahman2016\Model\Entity\Master get($primaryKey, $options = [])
 * @method \Lahman2016\Model\Entity\Master newEntity($data = null, array $options = [])
 * @method \Lahman2016\Model\Entity\Master[] newEntities(array $data, array $options = [])
 * @method \Lahman2016\Model\Entity\Master|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Lahman2016\Model\Entity\Master|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Lahman2016\Model\Entity\Master patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Lahman2016\Model\Entity\Master[] patchEntities($entities, array $data, array $options = [])
 * @method \Lahman2016\Model\Entity\Master findOrCreate($search, callable $callback = null, $options = [])
 */
